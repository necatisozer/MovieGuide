package com.esoxjem.movieguide.movies.utils
...
object DES {
    ...
    internal fun getSubKeys(key: String): Array<BitSet> {
    ...
    internal fun processMessage(message: String, ks: Array<BitSet>): String {
